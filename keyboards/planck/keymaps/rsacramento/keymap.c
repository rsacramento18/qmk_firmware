...
[_LOWER] = LAYOUT_planck_grid(
    _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,  KC_PAST, KC_SLSH,    KC_7,    KC_8,    KC_9, KC_BSLs, KC_BSPC,
     KC_DEL,   KC_F5,   KC_F6,   KC_F7,   KC_F8,  KC_MINS, KC_UNDS,    KC_4,    KC_5,    KC_6, ___x___, KC_PIPE,
...
[_RAISE] = LAYOUT_planck_grid(
    _______, _______, _______, KC_EXLM, KC_LPRN, KC_LPRN, KC_RPRN, KC_HASH,  KC_DLR, KC_AMPR, _______, KC_BSPC,
    _______, _______, _______, _______, KC_CIRC, KC_LCBN, KC_RCBN, KC_TILD, KC_MINS, KC_UNDS, _______, _______,
    _______, _______, _______, _______,  KC_GRV, KC_LBRC, KC_RBRC, CEDILHA, _______, _______, _______, _______,
